...
<body>
<h3>CRUD - PHP com mysqli - Exclus�o - Consulta do Produto</h3>
<?php
...
if (!$resultado) {
    ...
    if ($num == 0) {
        echo "<b>C�digo: </b>não localizado !!!!<br><br>";
        echo '<input type="button" onclick="window.location=' .
            "'exclusao.php'" .
            ';" value="Voltar"><br><br>';
        exit();
...
<b>Descrição: </b><br><textarea  rows='3' cols='100' style="resize: none;" readonly ><?php echo $dados[
    "descricao"
]; ?></textarea><br><br>
